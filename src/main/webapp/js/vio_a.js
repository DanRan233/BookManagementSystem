    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            var th = "<tr id=\"North_tr_One\" calss=\"tr\" style='background-color:#969696;'>\n" +
                "            <th id=\"North_th-Two\" class=\"th\">学号</th>\n" +
                "            <th id=\"North_th-Three\" class=\"th\">书籍编号</th>\n" +
                "            <th id=\"North_th-Nine\" class=\"th\">取消违约</th>\n" +
                "        </tr>"
            $("#TableOne").append(th)
...
$(document).on("click", ".ret", function () {
    var bID = this.id;
    if (confirm("您确定要消除违约吗？")) {
        $.ajax({
            url: "/vio/updateViolate",
            type: "post",
            async: true,
            contentType: "application/json",
            dataType: "json",
